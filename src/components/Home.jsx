  ...
  return (
    <main name="home" className='w-full h-screen bg-[#0a192f]'>
        <div className='max-w-[1000px] mx-auto flex flex-col justify-center h-full px-4'>
            ...
            <div>
                <button className='text-white border-2 px-6 py-3 my-2 flex items-center justify-between hover:bg-pink-600 hover:border-pink-600'>View Work  <HiArrowNarrowRight/> </button>
            </div>
        </div>
    </main>
  )
